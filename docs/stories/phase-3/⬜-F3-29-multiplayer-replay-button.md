...
- [ ] `MultiplayerResultScreen` affiche un bouton "Rejouer" en plus du bouton "Retour à l'accueil"
- [ ] Le bouton "Rejouer" réinitialise les scores et repart de la manche 1 avec les mêmes joueurs
- [ ] Le nombre de manches de la session précédente est conservé
