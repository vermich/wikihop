---
id: M-14
title: Affichage de l'image de résumé de l'article
phase: 2-MVP
priority: Could
agents: [Frontend Dev]
status: won't
...
## User Story
En tant que joueur, je veux voir l'image principale d'un article Wikipedia, afin de mieux m'orienter visuellement.
