# WikiHop — Suivi des bugs

Bugs remontés par le PO lors des tests utilisateurs.
Un bug n'est investigué qu'une fois reproductible plusieurs fois ou avec contexte suffisant.
